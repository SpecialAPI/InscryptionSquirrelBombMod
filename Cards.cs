...
namespace SquirrelBombMod
{
    public partial class Plugin
    {
        public static void AddCards()
        {
            ...
            CardManager.New(PREFIX, "ChainHeart", "Heart on a Chain", 1, 9, "Beautiful.")
                .SetPortrait(LoadTexture("portrait_chainheart.png"))
                .AddAbilities(Ability.Strafe, Ability.SplitStrike);

            CardManager.New(PREFIX, "Spamgel", "Spamgel", 1, 2, "The result of pressing F1.")
                .SetPortrait(LoadTexture("portrait_spamgel.png"))
                .AddAbilities(FindRegisteredAbility<DieHeal>())
                .SetTribes(Tribe.Squirrel);

            CardManager.New(PREFIX, "HandPhoneLeft", "Hand Phone", 0, 5, "Do you really need anyone else?")
                .SetPortrait(LoadTexture("portrait_leftphonehand.png"))
                .AddAbilities(FindRegisteredAbility<CreateSpamMailConduit>());

            CardManager.New(PREFIX, "HandPhoneRight", "Hand Phone", 0, 5, "Do you really need anyone else?")
            ...
            CardManager.New(PREFIX, "!GIANTCARD_NEO", "THE POWER OF NEO!!!", 1, 40, "Don't you wanna be a big shot?")
            ...
            //ending
            CardManager.New(PREFIX, "Receiver", "Receiver", -999, 99999, "The voice runs out eventually.")
            ...
            CardManager.New(PREFIX, "BearHeart", "Bear on a Chain", 1, 10, "Bearutiful.")
                .SetPortrait(LoadTexture("portrait_bearheart.png"))
                .AddAbilities(Ability.Strafe, Ability.TriStrike, Ability.MadeOfStone);

            CardManager.New(PREFIX, "HandBearLeft", "Bear Hand", 0, 5, "Do you really need anyone else?")
            ...
            CardManager.New(PREFIX, "HandBearRight", "Bear Hand", 0, 5, "Do you really need anyone else?")
